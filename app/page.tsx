...
const Home = () => {
  ...
  return (
    <article className="relative max-w-[425px] h-dvh mx-auto">
      <div
        id="inner"
        className="bg-white absolute w-full h-dvh sm:h-3/4 sm:left-1/2 sm:top-1/2 sm:-translate-x-1/2 sm:-translate-y-1/2 sm:rounded-xl overflow-clip shadow-2xl"
      >
